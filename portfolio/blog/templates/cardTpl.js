        ...
        <div class="col-12">
            <div class="card my-3">
                <div class="card-body bg-dark text-light border border-info shadow rounded">
                    ...
                    <a class="card-link text-warning" href="/igorhristov.github.io/portfolio/blog/article/index.html?id={{ id }}">
                        ...
                        <div class="col-10">
                            <div class="row">
                                ...
                                <div class="col-5">
                                    ...
                                    <a class="card-link rounded-pill border border-warning text-warning pb-1 px-2" href="/igorhristov.github.io/portfolio/blog/article/index.html?id={{ id }}#commentReplay"> 
                                        Join Conversation -> 
                                    </a>
                                </div>
                    ...
                    <div class="actions">
                        <a href="/igorhristov.github.io/portfolio/blog/article/index.html?id={{ id }}" class="card-link btn btn-outline-warning">Read More >>></a>
                    </div>
                    <div class="actions mt-5 mb-2">
                        {{#tags}}
                            <a href="../tags/index.html?tag={{ . }}" class="card-link rounded-pill border border-info text-info  pb-1 px-2"> {{ . }} </a>
                        {{/tags}}
                    </div>
                </div>
            </div>
